          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card-box-b card-shadow news-box">
                <div class="img-box-b">
                  <img src="../Resources/img/blog/gamificacion.jpg" alt="" class="img-b img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-header-b">
                    <div class="card-category-b">
                      <a href="BlogSingle.php" class="category-b">Developer</a>
                    </div>
                    <div class="card-title-b">
                      <h2 class="title-2">
                        Gamificación en enseñanza de poo                        
                      </h2>
                    </div>
                    <div class="card-date">
                      <span class="date-b">27 Mayo. 2020</span>
                    </div>
                  </div>
                </div>
              </div>
