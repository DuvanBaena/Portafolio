...
$data=new BaseDatos;
$records=$data->ListCurrentSumary();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa fa-bars"></i> Sumary</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="Dashboard.php">Home</a></li>
              <li><i class="fa fa-bars"></i>Sumary</li>
              <li><i class="fa fa-square-o"></i>Current Summary</li>
            </ol>
          </div>          
        </div>
        <div class="row">
            ...
            <section class="panel">                     
              ...
              <thead>
                <tr>
                  ...
                  <th><i class="icofont-id"></i> Place of study</th>
                  <th><i class="icofont-file-document"></i> Remark</th>  
              ...
              <?php
                if(count($records)>0){
                 for($i=0;$i<count($records);$i++){ ?>
                  <tr>
                    <td><?php echo $i+1;?></td>
                    <td><?php echo $records[$i]["PlaceStudy"];?></td>
