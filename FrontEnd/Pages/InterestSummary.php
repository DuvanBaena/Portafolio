    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa fa-bars"></i> Interest</h3>
            <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">            
              <a class="btn btn-success" href="AddInterestSummary.php"><i class="icofont-save"></i></a>  
            </div>
          </div>    
			   </br> 
        <div class="row">
              ...
              <?php
                if(count($records)>0){
                 for($i=0;$i<count($records);$i++){ ?>
                  <tr>
                    <td><?php echo $i+1;?></td>
                    <td><?php echo $records[$i]["NameInterest"];?></td>
                    <td><?php echo "<img src='../Resources/img/Interest/".$records[$i]["ImgInterest"]."' width=70>";$records[$i]["ImgInterest"];?></td>                                 
                     <td>
                      <div class="btn-group"> 
                        <a class="btn btn-warning" href="EditInterestSummary.php?id=<?php echo $records[$i]["InterestId"];?>" title="Edit"><i class="icofont-ui-edit"></i></a>                        
                        <button type="button" class="btn btn-danger" title="Delete" onclick="btnDeleteInterest(<?php echo $records[$i]["InterestId"];?>)"> <i class="icofont-garbage" aria-hidden="true"></i></button>                                         
                     </div>
                    </td>                    
                  </tr> 
                  <?php
