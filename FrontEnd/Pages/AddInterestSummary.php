...
<body>
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-horizontal" id="AddInterest" autocomplete="off">
                   <div class="form-group ">
                      <label  class="control-label col-lg-2">Name Technology</label>
                      <div class="col-lg-5">
                          <input class="form-control" id="TechName" name="TechName" placeholder="Example Azure">
                        </div>                 
                                            
                        <div class="col-lg-5">
                        <input type="file" class="form-control date"  id="TechImg" name="TechImg" placeholder="img">
                        </div>
                    </div>                     
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">                                            
                      <button type="button" class="btn btn-primary" id="BtnAddInterest">Save</button>                       
  ...
  <script>  
  document.getElementById("BtnAddInterest").onclick = AddInterest;
