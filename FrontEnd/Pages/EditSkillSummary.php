...
if (isset($_REQUEST['id'])){
   ...
   $data=new BaseDatos;
   $records=$data->GetInfoSkillById($_REQUEST['id']); 
 }
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
      ...
      <div class="row">
          <div class="col-lg-12">          
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-files-o"></i>Edit Skill Summary</li>
            </ol>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-horizontal" id="EditSkillSummary" autocomplete="off">
                  <div class="form-group" style="display: none">
                      <label  class="control-label col-lg-2">Id</label>
                      <div class="col-lg-10">
                        <input class="form-control " id="SkillId" type="text" name="SkillId"
                        value="<?php echo $records[0]['SkillId'];?>" disabled>                        
                      </div>
                    </div> 
                   <div class="form-group ">
                      <label  class="control-label col-lg-2">Name Technology</label>
                      <div class="col-lg-5">
                          <input type="text" class="form-control" placeholder="Example Azure" id="SkillName" name="SkillName"
                          value="<?php echo $records[0]['SkillName'];?>">
                        </div>
                        <div class="col-lg-4">                          
                        ...
                        <div class="col-lg-1">
                          <input type="text" class="form-control" placeholder="43%" id="SkillValue" name="SkillValue"
                          value="<?php echo $records[0]['SkillValue'];?>">
                        </div>
                    </div>   

                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">                                            
                      <button type="button" class="btn btn-primary" id="BtnEditSkillSummary">Save</button>                       
                        <button class="btn btn-default" type="button" onclick="ReturnSkillSummary()">Cancel</button>
                      </div>
                    </div>
                  </form>
                </div>
  ...
  <script>  
  document.getElementById("BtnEditSkillSummary").onclick = UpdatetSkillSummary; 
