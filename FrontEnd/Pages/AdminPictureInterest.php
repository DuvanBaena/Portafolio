...
$data=new BaseDatos;
if (isset($_REQUEST['n'])) $mensaje=$data->DeletePictureInterest();
if (count($_FILES)>0) $mensaje=$data->UploadImgInterest();
$records=$data->ListPictureInterest();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div id="loader-wrapper" style="display: none">
          ...
          <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa fa-bars"></i> Book's <?php 
        ...
        <div class="row">
            ...
            <div id="InputFile" style="display:none">
              <div>
                <form method="POST" action="AdminPictureInterest.php" enctype="multipart/form-data" class="form-inline">
              ...
              <tbody>       
                ...
                if(count($records)>0){
                 for($i=0;$i<count($records);$i++){ ?>
                  <tr>                                    
                    <td><?php echo $i+1;?></td> 
                    <td><?php echo "<img src='../../FrontEnd/Resources/img/Interest/".$records[$i]["nombre"]."' width=80>";?></td>            
                    ...
                    <td>
                      <div class="btn-group">                         
                        ...
                        <a class="btn btn-danger" href="AdminPictureInterest.php?n=<?php echo $records[$i]["nombre"];?>" title="Delete"  id="BtnDelete"><i class="icofont-garbage"></i></a>
                      </div>
                    </td>
                  </tr> 
                  <?php 
