...
if (isset($_REQUEST['id'])){
   ...
   $data=new BaseDatos;
   $records=$data->GetInfoInterestById($_REQUEST['id']); 
 }
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
      ...
      <div class="row">
          <div class="col-lg-12">          
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-bars"></i>Interest</li>
              <li><i class="fa fa-square-o"></i>Interest Summary</li>
            </ol>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-horizontal" id="UpdateInterest" autocomplete="off">
                  <div class="form-group" style="display: none">
                      <label  class="control-label col-lg-2">Id</label>
                      <div class="col-lg-10">
                        <input class="form-control " id="InterestId" type="text" name="InterestId"
                        value="<?php echo $records[0]['InterestId'];?>" disabled>                        
                      </div>
                    </div> 
                   ...
                   <div class="form-group ">
                      ...
                      <div class="col-lg-5">
                          <input class="form-control" id="TechName" name="TechName" placeholder="Example Azure" value="<?php echo $records[0]['NameInterest'];?>">
                        </div>                 
                                            
                        <div class="col-lg-5">
                          <input class="form-control" id="TechImg" name="TechImg" placeholder="Azure.png" value="<?php echo $records[0]['ImgInterest'];?>">
                        </div>
                    </div>                     
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">                                            
                      <button type="button" class="btn btn-primary" id="BtnAUpdateInterest">Save</button>                       
                        <button class="btn btn-default" type="button" onclick="ReturnInterest()">Cancel</button>
                      </div>
                    </div>
                  </form>
                </div>
  ...
  <script>  
  document.getElementById("BtnAUpdateInterest").onclick = UpdateInterest;
