...
<body>
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-horizontal" id="AddSkillSummary" autocomplete="off">
                   <div class="form-group ">
                      <label  class="control-label col-lg-2">Name Technology</label>
                      <div class="col-lg-5">
                          <input class="form-control" id="SkillName" name="SkillName" placeholder="Example Azure">
                        </div>
                        <div class="col-lg-4">                          
                        ...
                        <div class="col-lg-1">
                          <input type="text" class="form-control"  id="SkillValue" name="SkillValue" placeholder="43%">
                        </div>
                    </div>                     
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">                                            
                      <button type="button" class="btn btn-primary" id="BtnAddSkillSummary">Save</button>                       
  ...
  <script>  
  document.getElementById("BtnAddSkillSummary").onclick = AddSkillSummanry;
